...
public class HT_InnerVideo3 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    public static final String API_KEY = "AIzaSyCtHBUpTKgzM4BUS07SrUP1qc4cSmeglro";
    public static final String VIDEO_ID = "GbzGRoPNgAY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YouTubePlayerView youTubePlayerView = (YouTubePlayerView) findViewById(R.id.youtube_player3);
        youTubePlayerView.initialize(API_KEY, this);
    }
    @Override
    protected void onResume() {
        super.onResume();
        LinearLayout layout = (LinearLayout)findViewById(R.id.backvideo3);
        ...
        LinearLayout layout2 = (LinearLayout)findViewById(R.id.innervideo3);
        ...
        ImageView img = (ImageView) findViewById(R.id.videotop3);
        img.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource(getResources(), R.drawable.videotop3)));
    ...
    protected void onDestroy() {
        ...
        recycleView(findViewById(R.id.backvideo3));
        recycleView(findViewById(R.id.innervideo3));
        recycleView(findViewById(R.id.videotop3));
    }
