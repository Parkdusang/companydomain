...
public class HT_InnerVideo4 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onResume() {
        super.onResume();
        LinearLayout layout = (LinearLayout)findViewById(R.id.backvideo4);
        ...
        LinearLayout layout2 = (LinearLayout)findViewById(R.id.innervideo4);
        ...
        ImageView img = (ImageView) findViewById(R.id.videotop4);
        img.setBackgroundDrawable(new BitmapDrawable(getResources(), BitmapFactory.decodeResource(getResources(), R.drawable.videotop4)));
    ...
    protected void onDestroy() {
        ...
        recycleView(findViewById(R.id.backvideo4));
        recycleView(findViewById(R.id.innervideo4));
        recycleView(findViewById(R.id.videotop4));
    }
